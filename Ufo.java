...
public class Ufo {
    ...
    public Ufo(double pX, double pY,
        ...
        this.ufoMoved = (int) Math.round(ufoBild.getShapeX());
    ...
    public int getUfoXPosition() {
        return this.ufoMoved;
    }
    
    public void setUfoXPostion(int x) {
        this.ufoMoved += x;
    }
    ...
    public boolean istKollidiert() {
        ...
        if (
            ufoBild.intersects(speedBoost.getShapeAsImg())
        ) {
        ...
        if (
            ufoBild.intersects(defence.getShapeAsImg())
        ) {
            defence.getShapeAsImg().setHidden(true);
            laser.setLaserActivated(true);
        }
